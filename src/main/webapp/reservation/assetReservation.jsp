...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function handleEventSubmit() {
            ...
            let url = '/assetReservation/addReservation';
        ...
        function handleEventDelete() {
            ...
            let url = '/assetReservation/delReservation';
    ...
    function reservSearch() {
        ...
        fetch('/assetReservation/reservList', {
            method: 'GET',
            headers: {
    ...
    function updateReservationList() {
        let xhr = new XMLHttpRequest();
        let url = '/assetReservation/reservationList';
        ...
        <div style="width: 100%; height: 100px; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
            ...
            <div style="padding-top: 14px; padding-bottom: 6px; justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex">
                ...
                <div style="justify-content: flex-start; align-items: center; gap: 12px; display: flex">
                    ...
                    <div style="color: rgba(0, 0, 0, 0.45); font-size: 14px; font-family: Roboto; font-weight: 400; line-height: 22px; word-wrap: break-word">자산예약 현황을 조회할 수 있는 페이지입니다.</div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="container-fluid1">
                            ...
                            <button id="addEventBtn" class="btn btn-primary col-md-1">예약 등록</button>
                        </div>
                        <hr />
