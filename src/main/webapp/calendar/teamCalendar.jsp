...
<script>
    ...
    function calendarSearch() {
        ...
        let searchURL = "/calendar/teamCalendarList?gubun=" + gubun;
                        ...
                        <div class="container-fluid1">
                            ...
                            <div class="container-fluid">
                                <table class="table">
                                    ...
                                    <% List<CalendarVO> teamCalendarList1 = (List<CalendarVO>) request.getAttribute("teamCalendarList");
                ...
                <div class="modal-content rounded-4 shadow">
                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <select class="form-control" id="insertCalendarId" name="insertCalendarId">
                            ...
                            <option value="2" selected>팀일정</option>
