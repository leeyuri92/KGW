    ...
    <div class="content-wrapper">
        ...
        <div class="box-header p-4">
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <div class="text-dark fs-6">내 일정</div>
                </div>
            </div>
            <div class="d-flex align-items-center mt-3">
                ...
                <div class="d-flex align-items-center ms-2">
                    <div class="fw-bold fs-5">내 일정 현황</div>
                    <div class="text-muted ms-3">내 일정 현황을 조회할 수 있는 페이지입니다.</div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="container-fluid1">
                            <h4 class="cal_title">내 일정 현황</h4>
                            <input type="button" class="w-100 mb-2 btn btn-lg rounded-3 btn-primary col-sm-1" id="addEvent" name="addEvent" value="일정 등록"/>
                        </div>
                        <hr />
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded-4 shadow">
                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-3" id="name" name="name" placeholder="생성자" value="<%=sessionVO.getName()%>">
                            <label for="name">생성자</label>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <select class="form-control" id="insertCalendarId" name="insertCalendarId">
                            ...
                            <option value="1" selected>내일정</option>
